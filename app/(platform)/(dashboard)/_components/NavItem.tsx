    ...
    return (
        <AccordionItem value={organization.id} className="border-none">
            <AccordionTrigger onClick={() => onExpand(organization.id)} className={
                cn("flex items-center gap-x-2 p-1.5 text-neutral-700 rounded-md hover:bg-neutral500/10 transition text-start no-underline hover:no-underline",
...
NavItem.Skeleton = function SkeletonFunction() {
    return (
        <div className="flex items-center gap-x-2">
