            ...
            <div className="grid grid-cols-3 gap-2 mb-2">
                {images.map((image) => (
                    <div
                        ...
                        <Link href={image.links.html} target="_blank" className="opacity-0 group-hover:opacity-100 absolute bottom-0 w-full text-[10px] truncate text text-white hover:underline p-1 bg-black/50">
                            {image.user.name}
                        </Link>
                    </div>
                ))}
